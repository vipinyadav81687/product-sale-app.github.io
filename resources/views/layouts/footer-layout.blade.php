            ...
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                <a href="" class="text-decoration-none">
                    <h1 class="mb-4 display-5 font-weight-semi-bold"><span
                            class="text-primary font-weight-bold border border-white px-3 mr-1">{{ getAppData('logo_first_text') }}</span>{{ getAppData('logo_second_text') }}
                    </h1>
                </a>
                ...
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            @foreach (getMenu('quick_links_1') as $menu)
                                <a class="text-dark mb-2" href="{{ $menu->full_url }}"><i
                                        class="fa fa-angle-right mr-2"></i>{{ $menu->name }}</a>
                            @endforeach
                    ...
                    <div class="col-md-4 mb-5">
                        <h5 class="font-weight-bold text-dark mb-4">Quick Links</h5>
                        <div class="d-flex flex-column justify-content-start">
                            @foreach (getMenu('quick_links_2') as $menu)
                                <a class="text-dark mb-2" href="{{ $menu->full_url }}"><i
                                        class="fa fa-angle-right mr-2"></i>{{ $menu->name }}</a>
                            @endforeach
            ...
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-dark">
                    &copy; <a class="text-dark font-weight-semi-bold"
                        href="{{ route('index') }}">{{ getAppData('site_name') }}</a>. All Rights Reserved. Designed
                    by
