                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="logo_first_text"
                                    placeholder="Logo First Text"
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="logo_second_text"
                                    placeholder="Logo Second Text"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="contact_touch_text"
                                    ...
                                    value="{{ isset($data->contact_touch_text) ? $data->contact_touch_text : '' }}">
