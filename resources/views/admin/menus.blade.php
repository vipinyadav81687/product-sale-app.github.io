...
@section('content')
        ...
        <tbody>
            @foreach ($menus as $menu)
                <tr>
                    ...
                    <td>
                        <button class="btn btn-danger deleteBtn" data-id="{{ $menu->id }}" data-toggle="modal"
                            data-target="#deleteMenuModal">
                            Delete
                        </button>
                        <button class="btn btn-primary editBtn" data-obj="{{ $menu }}" data-toggle="modal"
    ...
    <!--Create Modal -->
    <div class="modal fade" id="createMenuModal" tabindex="-1" role="dialog" aria-labelledby="createMenuModalTitle"
        aria-hidden="true">
    ...
    <!-- Delete Modal -->
    <div class="modal fade" id="deleteMenuModal" tabindex="-1" role="dialog" aria-labelledby="createMenuModalTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- Update Modal -->
    <div class="modal fade" id="updateMenuModal" tabindex="-1" role="dialog" aria-labelledby="createMenuModalTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
