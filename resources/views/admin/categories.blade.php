...
@section('content')
        ...
        <tbody>
            @foreach ($allCategories as $category)
                <tr>
                    ...
                    <td>
                        <button class="btn btn-danger deleteBtn" data-id="{{ $category->id }}" data-toggle="modal"
                            data-target="#deleteCategoryModal">
                            Delete
                        </button>
                        <button class="btn btn-primary editBtn" data-obj='@json($category)' data-toggle="modal"
    ...
    <div class="modal fade" id="createCategoryModal" tabindex="-1" role="dialog"
        aria-labelledby="createCategoryModalTitle" aria-hidden="true">
    ...
    <!-- Delete Modal -->
    <div class="modal fade" id="deleteCategoryModal" tabindex="-1" role="dialog" aria-labelledby="createMenuModalTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
