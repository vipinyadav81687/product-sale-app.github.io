...
@section('content')
        ...
        <tbody>
            @foreach ($banners as $banner)
                <tr>
                    ...
                    <td>
                        <button class="btn btn-primary editBtn" data-obj='@json($banner)' data-toggle="modal"
                            data-target="#updateModal">
                            Edit
                        </button>
                        <button class="btn btn-danger deleteBtn" data-id="{{ $banner->id }}" data-toggle="modal"
    ...
    <!-- Delete Modal -->
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="createMenuModalTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
